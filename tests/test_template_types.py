...
@pytest.mark.parametrize('template_class, extra_args, expected_field_calls', [
    (Template, {}, [
        mock.call('content', {}, html='escape', redact_missing=False),
    ]),
    (WithSubjectTemplate, {}, [
        mock.call('content', {}, html='escape', redact_missing=False),
    ]),
    ...
    (HTMLEmailTemplate, {}, [
        mock.call('content', {}, html='escape', markdown_lists=True, redact_missing=False)
    ]),
    (EmailPreviewTemplate, {}, [
        mock.call('content', {}, html='escape', markdown_lists=True, redact_missing=False),
        mock.call('subject', {}, html='escape', redact_missing=False),
    ...
    (LetterPreviewTemplate, {'contact_block': 'www.gov.uk'}, [
        ...
        mock.call('www.gov.uk', {}, html='escape', redact_missing=False),
    ]),
    ...
    (Template, {'redact_missing': True}, [
        mock.call('content', {}, html='escape', redact_missing=True),
    ]),
    (WithSubjectTemplate, {'redact_missing': True}, [
        mock.call('content', {}, html='escape', redact_missing=True),
    ]),
    (EmailPreviewTemplate, {'redact_missing': True}, [
        mock.call('content', {}, html='escape', markdown_lists=True, redact_missing=True),
        mock.call('subject', {}, html='escape', redact_missing=True),
        mock.call('((email address))', {}, with_brackets=False),
    ]),
    (SMSPreviewTemplate, {'redact_missing': True}, [
        mock.call('((phone number))', {}, with_brackets=False, html='escape'),
        mock.call('content', {}, html='escape', redact_missing=True),
    ]),
    (LetterPreviewTemplate, {'contact_block': 'www.gov.uk', 'redact_missing': True}, [
        mock.call('subject', {}, html='escape', redact_missing=True),
        mock.call('content', {}, html='escape', markdown_lists=True, redact_missing=True),
        mock.call((
            '((address line 1))\n'
        ...
        mock.call('www.gov.uk', {}, html='escape', redact_missing=True),
    ]),
])
